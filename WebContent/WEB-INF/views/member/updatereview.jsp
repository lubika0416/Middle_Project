...
<html lang="en">
  ...
  <body>
	...
	<%
	ReviewVO rv = (ReviewVO)request.getAttribute("review");
	%>
    <div class="container">
      <div
      ...
      >
        <div class="input-form col-md-6 mx-auto" style="padding: 30px">
          <h3 class="mb-4 fw-bold" style="text-align: center">리뷰 수정</h3>
          <form
            class="validation-form"
            novalidate
            method="post"
            action="<%=request.getContextPath()%>/member/updatereview.do"
            ...
            <div class="row" style="display: flex; justify-content: center;">
              <div class="col-md-8 my-2">
                <label for="exampleTextarea" class="form-label">작성 내용</label>
                    ...
                    <textarea class="form-control" id="exampleTextarea" name="reviewContent" rows="5"><%=rv.getReviewContent()%></textarea>
                              </div>
