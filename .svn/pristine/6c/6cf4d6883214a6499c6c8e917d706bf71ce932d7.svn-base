...
<body>
<nav class="main-nav" style="width: 1120px; margin:auto;">

<div class="sub-title">
<h1><b>자주 묻는 질문</b></h1>
</div>
<div style="margin-top: 10vh; height: auto; min-height:60vh; width: 1120px;">
  <table class="table" style="margin: 40px 0px; width:100%;">
    ...
    %>
      <tr>
        <td class="text-center" style="width:250px;">&nbsp;&nbsp;<%= list.get(i).getFaqNo() %></td>
        <td>
        	 <div class="panel-faq-container" style="height: fit-content;">
              <p class="panel-faq-title">Q . &nbsp;&nbsp;<%= list.get(i).getFaqTitle() %></p>
              <div class="panel-faq-answer">
                <p  style="height: 200px; overflow-y: scroll;">A . &nbsp;&nbsp;<%=list.get(i).getFaqContent() %></p>
              </div>
            </div>
        </td>
      </tr>
