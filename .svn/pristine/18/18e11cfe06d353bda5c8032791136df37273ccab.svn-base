...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <html lang="en">
      <head>
        ...
        />
        <link
          href="<%=request.getContextPath()%>/css/proMypage.css"
          rel="stylesheet"
        />
        <link
          href="<%=request.getContextPath()%>/css/classManagement.css"
          rel="stylesheet"
        />
        <link
          rel="stylesheet"
...
.aaa:hover {
	...
	color: var(--CI, #00E577) !important;
      ...
      <body>
      	<%
        FeedVO fdv = (FeedVO)request.getAttribute("fdv");
	...
	<div class="mypagimargin" style="padding: 8px;">
		<div class="calbox3">
			<div class="mycontenttitle">피드 수정</div>

			<hr class="mycontentbar2" />

			<div style="display: flex; justify-content: center; padding: 40px;">
				<div class="row d-flex w-75" style="align-items: center;">
					<form action="<%=request.getContextPath()%>/producer/updatefeed.do"
						method="post" 
						...
						<div class="formcontainer">
							...
							name="feedContent" minlength="10" ><%=fdv.getFeedContent()%></textarea>
						</div>
						<div class="formcontainer">
							<label for="classImg">피드 사진</label> <input type="file"
								class="form-control" id="classImg" accept="image/*" 
