...
@WebServlet("/admin/reviewBoard.do")
public class AdminReviewBoardController extends HttpServlet {
...
//		List<ReviewVO> list = service.boardList(map);
//		
...
//				
//		RequestDispatcher disp = req.getRequestDispatcher("WEB-INF/view.admin/reviewAdmin.jsp");
